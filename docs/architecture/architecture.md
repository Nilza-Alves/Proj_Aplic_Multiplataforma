>>>>>>>>  Arquitetura do Sistema: Instituto Além dos Olhos <<<<<<<<<<<<
...
![Diagrama de Arquitetura](docs/architecture/diagrama_arquitertura.drawio.png)
![Diagrama de Arquitetura](docs/architecture/diagrama_arquitetura.drawio.png)
